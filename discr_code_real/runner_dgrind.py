...
def main_dgrind(regress, principal, agents, oracle, resp_lst, curr_rep, T, num_agents, d, subgroup, pop_X, pop_Y, p):   
    temp_regr = []
    algo_loss = []
    actions_taken   = []
    updated         = []
    ...
    min_fair_loss, fairest_arm, fair_arm_index, ranking = find_optimal_rule(principal.calA, metric, d, agents[0].delta, subgroup, pop_X, pop_Y)
