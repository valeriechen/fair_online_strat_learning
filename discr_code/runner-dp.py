...
T = max_num_rounds
(num_agents, dim, x_real, calA, agent_types, true_labels, delta, noise, p, subgroup) = set_params(T)
...
if __name__ == '__main__':
    ...
    for p in prob:
        regr = main_dgrind(regress, principal[0], agents, oracle, resp_lst, 0, T, num_agents, dim, subgroup, p)
